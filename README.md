...
- Basic CSS properties (padding, margin, colors, fonts)
...
1. Clone this repository:
   ```bash
   git clone https://github.com/YOUR-USERNAME/hvac-solutions.git
   ```
...
✅ Review class code  
✅ Create two sections in a single HTML file  
✅ Use only inline style attributes  
✅ Use appropriate images  
✅ Follow beginner-level coding practices  
